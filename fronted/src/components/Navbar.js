...
function Navbar({isConnectedToPeraWallet, handleConnectWalletClick, handleDisconnectWalletClick}) {
    return (
        <>
        <nav>
            <a href="index.html" id="app-frame">
            ...
            <h1 id="app-name">AlgoEcoPower</h1>
            </a>
